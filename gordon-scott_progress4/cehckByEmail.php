<?php
    ...
    if ($perm_num == NULL) {
      echo "<p style='font-size:20px;'>No assigned permission number found for email <b>$student_email</b> for <b>$class</b>. If you need a permission number please go back and use the request form.</p>";
      exit(1);
    }
